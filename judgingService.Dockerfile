...
CMD java --enable-preview -Dlog.dir=/var/log/swe2023brown/exam-judging-service -jar exam-judging-service-${VERSION}.jar --spring.config.location=classpath:/application.yml,optional:/etc/swe2023brown/exam-judging-service/application.yml
