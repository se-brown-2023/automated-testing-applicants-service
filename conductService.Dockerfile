...
CMD java -jar exam-conduct-service-${VERSION}.jar --spring.config.location=classpath:/application.yml,optional:/etc/swe2023brown/exam-conduct-service/application.yml -Dlog.dir=/var/log/swe2023brown/exam-conduct-service
