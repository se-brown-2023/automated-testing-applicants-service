...
CMD java -Dlog.dir=/var/log/swe2023brown/exam-manage-service -jar exam-manage-service-${VERSION}.jar --spring.config.location=classpath:/application.yml,optional:/etc/swe2023brown/exam-manage-service/application.yml
